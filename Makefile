...
main_client1: main_client1.o func_client.o func.o
	gcc -g -pthread build/main_client1.o build/func_client.o build/func.o -o bin/main_client1
...
main_server2: main_server2.o func_serv.o func.o
	gcc -g -pthread build/main_server2.o build/func_serv.o build/func.o -o bin/main_server2
