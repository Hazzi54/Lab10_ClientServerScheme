...
main_client1: main_client1.o func.o
	gcc -g build/main_client1.o build/func.o -o bin/main_client1

main_server1: main_server1.o func.o
	gcc -g build/main_server1.o build/func.o -o bin/main_server1

main_server1.o: src/first_scheme/main_server.c src/func.h
	gcc -g -c src/first_scheme/main_server.c -o build/main_server1.o

main_client1.o: src/first_scheme/main_client.c src/func.h
	gcc -g -c src/first_scheme/main_client.c -o build/main_client1.o
