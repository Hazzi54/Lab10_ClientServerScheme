...
all: bin build main_client1 main_server1 main_server2 main_server3

main_client1: main_client1.o func_client.o func.o
	gcc -g -pthread build/main_client1.o build/func_client.o build/func.o -o bin/client
...
main_server3: main_server3.o func_serv.o func.o
	gcc -g -pthread build/main_server3.o build/func_serv.o build/func.o -o bin/server3

main_server3.o: src/third_server.c src/func_serv.h
	gcc -g -pthread -c src/third_server.c -o build/main_server3.o
